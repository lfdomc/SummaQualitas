...
function ReportGenerator() {
  ...
  return (
    <div className="space-y-6">
      {/* Selección de Proyectos - Ahora es lo primero */}
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                <SelectItem key="currency-both" value="both">Ambas Monedas</SelectItem>
                <SelectItem key="currency-CRC" value="CRC">Colones (CRC)</SelectItem>
                <SelectItem key="currency-USD" value="USD">Dólares (USD)</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </CardContent>
