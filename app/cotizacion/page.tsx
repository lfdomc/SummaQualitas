      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Request Quote</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">1. Complete the Form</h3>
              <p className="text-gray-600 text-sm">Provide your project details</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Clock className="h-8 w-8 text-blue-600" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2">2. Technical Analysis</h3>
              <p className="text-gray-600 text-sm">Our team evaluates your project</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Calculator className="h-8 w-8 text-blue-600" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2">3. Detailed Quote</h3>
              <p className="text-gray-600 text-sm">Receive a complete proposal</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <CheckCircle className="h-8 w-8 text-blue-600" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2">4. Follow-up Meeting</h3>
              <p className="text-gray-600 text-sm">We discuss the details with you</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <Card>
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-gray-900">Project Information</CardTitle>
                <CardDescription>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Approximate Area (m²) *</label>
                        <Input
                          required
                          value={formData.area}
                      ...
                      <div>
                        ...
                        <Select onValueChange={(value) => setFormData({ ...formData, timeline: value })}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="1-3-meses">In 1-3 months</SelectItem>
                            <SelectItem value="3-6-meses">In 3-6 months</SelectItem>
                            <SelectItem value="6-12-meses">In 6-12 months</SelectItem>
                            <SelectItem value="mas-12-meses">More than 12 months</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why choose our quote?</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center">
              <CardHeader>
                ...
                <CardTitle>Free and No Commitment</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="text-center">
              <CardHeader>
                ...
                <CardTitle>Response in 24 Hours</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
